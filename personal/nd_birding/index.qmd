...
![Flocks of Black-headed Gulls in Winter Coat, Suzhou Jiangsu, Dec '25](headline.jpg)
...
# summary charadriiformes
charadriiformes_n <- nrow(
  bird_list[bird_list$Family %in% 
    c("Gulls, Terns, Skimmers", "Shorebirds"), ]
)

# summary corvidae
corvidae_n <- nrow(
  bird_list[bird_list$Family %in% 
    c("Jays, Magpies, Crows, Ravens"), ]
)
```

#### Milestones

Now I've observed <code>`r nrow(bird_list)`</code> bird species, in which <code>`r result$count[result$location == "US"]`</code> of them were found in the United States.

- **100 birds spotted**: June 2025

- **125 birds spotted**: Oct 2025

- **150 birds spotted**: Jan 2026
...
::: column-margin
![View of Dushu Lake from Banyue Bay Lawn, Dec 2025](landspics/dushulake.JPG){group="landspics"}
:::

-   **Type**: Urban \| Freshwater; Lake, Lawn
