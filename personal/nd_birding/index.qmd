...
- ***American Woodcock***, the hype is up when spring comes...
:::
...
-   **Type**: Rural \| Freshwater; Marsh, Pond, Woods
...
-   **Comments**: Beautiful and peaceful place. Staff at the natural center are very friendly. It's home to several raptors, and you can also watch blue herons catching fish. I often start walking at Cherry Ln/Purdue University Student Farm, and ends the trail at Walmart supercenter to take CityBus #21 back home, which would typically take 2-3 hours. 
-   **Link**: [ebird](https://ebird.org/hotspot/L445373)
-   **My Review**: [Mar '26 Spring Migration](../260326_birding_celerybog/index.qmd)

#### ![](pixelart/treeswallow_s.png) West Lafayette, IN: Celery Bog - North Pond

::: column-margin
![View of Celery Bog, North Pond from Cattail Trail, Mar 2026](landspics/celerybognorth.JPG){group="landspics"}
:::
...
-   **Comments**: Nice trail. A large flock of robins and starlings rest on the trees near the open grass edge, and you can find jays and woodpeckers in the trails through the woods. During summer, a lot of songbirds rest and sing on trees near the woods edges. 
...
#### ![](pixelart/redwingedblackbird_s.png) Baltimore, MD: Patterson Park

::: column-margin
![Patterson Park, May 2025](landspics/pattersonpark.JPeG){group="landspics"}
:::

-   **Type**: Urban \| Freshwater; Woods, Pond
...
-   **Type**: Rural \| Brackish; Shore, Wetland, Woods
...
-   **Type**: Rural \| Freshwater; Woods, River
...
#### ![](pixelart/brant_s.png) New York City, NY: Liberty Island
...
-   **Type**: Rural \| Freshwater; Pond, Woods, Wetland
-   **First Visited**: June 2025
...
-   **Type**: Rural \| Freshwater; Pond, Woods, Marsh
